...
import '../player/youtube_player_native.dart';
import '../utils/youtube_meta_data.dart';
import '../utils/youtube_player_controller_native.dart';
import '../widgets/widgets.dart';

/// Shows [YoutubePlayer] in fullScreen landscape mode.
Future<void> showFullScreenYoutubePlayerNative({
  @required BuildContext context,
  @required YoutubePlayerControllerNative controller,
  ...
  String thumbnailUrl,
    ...
    await Navigator.push(
      context,
      _YoutubePageRoute(
        builder: (context) => _FullScreenYoutubePlayerNative(
...
class _FullScreenYoutubePlayerNative extends StatefulWidget {
  ...
  _FullScreenYoutubePlayerNative({
    Key key,
  ...
  @override
  _FullScreenYoutubePlayerNativeState createState() =>
      _FullScreenYoutubePlayerNativeState();
}

class _FullScreenYoutubePlayerNativeState extends State<_FullScreenYoutubePlayerNative> {
  @override
  Widget build(BuildContext context) {
    return YoutubePlayerNative(
