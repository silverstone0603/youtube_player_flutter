...
import 'package:youtube_player_flutter/src/widgets/loading_widget_native.dart';
...
import 'fullscreen_youtube_player_native.dart';
import 'raw_youtube_player_native.dart';
...
/// ```
///
class YoutubePlayerNative extends StatefulWidget {
  ...
  @override
  _YoutubePlayerNativeState createState() => _YoutubePlayerNativeState();
}

class _YoutubePlayerNativeState extends State<YoutubePlayerNative> {
  YoutubePlayerControllerNative controller;
  InAppWebViewController _cachedInAppWebViewController;
  ...
  @override
  void didUpdateWidget(YoutubePlayerNative oldWidget) {
  ...
  void listener() async {
    ...
    if (controller.value.toggleFullScreen) {
      ...
      if (controller.value.isFullScreen) {
        ...
        _cachedInAppWebViewController = controller.value.inAppWebViewController;
        controller.reset();

        await showFullScreenYoutubePlayerNative(
          context: context,
        ...
        controller
          ..updateValue(
            controller.value.copyWith(inAppWebViewController: _cachedInAppWebViewController),
          )
  ...
  Widget build(BuildContext context) {
    return Material(
      elevation: 0,
      color: Colors.black,
      child: InheritedYoutubePlayerNative(
        controller: controller,
        child: Container(
          color: Colors.black,
